...
$cammand="select * from users where phone='0783716425'";
$dataset=mysqli_query($connect,$cammand);
$row=mysqli_fetch_assoc($dataset);
//for sale
$camand1="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID where Style_home1='for sale'and province_Address='kunduz'";
$dataset1=mysqli_query($connect,$camand1);
$row1=mysqli_fetch_assoc($dataset1);
//for rent
$camand2="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID where Style_home1='for rante'and province_Address='kunduz'";
$dataset2=mysqli_query($connect,$camand2);
$row2=mysqli_fetch_assoc($dataset2);
//for grawy
$camand3="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID where Style_home1='Gravy'and province_Address='kunduz'";
