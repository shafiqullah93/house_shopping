...
$camand="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID";
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">مجموعه خانه های سایت رهنمای معاملات</h1>
            <span class="color-text-a">خبر تازه</span>
          </div>
        </div>
        <div class="col-md-12 col-lg-4">
          <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
            <ol class="breadcrumb">
             ...
             <h1 style="color:orange;">   خوش آمدید به این صفحه</h1>
              </li>
            </ol>
          </nav>
        </div>
              ...
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">for 6Month Graw| [$ <?php echo $row["Home_price"];?>]</span>
                  </div>
