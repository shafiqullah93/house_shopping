...
$camand="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID where Style_home1='for rante'";
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">لیست خانه های کرایه</h1>
            <span class="color-text-a">بهترین خانه های کرایه</span>
          </div>
        </div>
	  ...
	  <?php  do{?>
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="(1)assets/orginal/img/property-3.jpg" alt="" class="img-a img-fluid">
            </div>
              ...
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">1 Month rent | [$ <?php echo $row["Home_price"];?>]</span>
                  </div>
