...
$camand="select * from  ragisterform inner join home_address on ragisterform.ID=home_address.H_ID where Style_home1='Gravy'";
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
           <h1 class="title-single">لیست خانه های گروی</h1>
            <span class="color-text-a">خوش آمدید</span>
          </div>
        </div>
